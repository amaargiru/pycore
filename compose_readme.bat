...
copy 01_python_01_data_structures.md + 01_python_02_primitive_data_processing.md + 01_python_03_runtime_data_flows.md + 01_python_04_oop.md + 01_python_05_language_skeleton.md + 01_python_06_multithreading_multiprocessing.md + 01_python_07_useful_libraries.md + 02_sql.md + 03_architecture.md + 04_algorithms.md + 05_admin_devops.md + 06_pytest_mock.md + 07_fastapi.md + 08_flask.md readme.md
